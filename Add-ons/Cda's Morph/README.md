...
If you would like to upvote or downvote an Issue, Optimization, or Feature Request, react to the first message (the one the reporter sends) with either a 👍(upvote) or 👎(downvote)
